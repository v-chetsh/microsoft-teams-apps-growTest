            ...
            CancellationToken cancellationToken)
        {
            try
            {
                ...
                if (joinProjectData.Command == JoinProjectCommand)
                {
                    ...
                    if (projectDetails != null && !projectDetails.IsRemoved && (projectDetails.Status == (int)ProjectStatusEnum.NotStarted || projectDetails.Status == (int)ProjectStatusEnum.Active))
                    {
