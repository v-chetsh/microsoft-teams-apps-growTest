...
#pragma warning restore CA1062 // project details are validated by model validations for null check and is responded with bad request status
            ...
            try
            {
                var projectEntity = new ProjectEntity
                {
                    ...
                    Status = (int)ProjectStatusHelper.ProjectStatusEnum.NotStarted, // Project status as 'Not Started'.
...
#pragma warning restore CA1062 // project details are validated by model validations for null check and is responded with bad request status
        ...
        public async Task<IActionResult> DeleteAsync(string projectId)
        {
            ...
            try
            {
                ...
                if (projectDetails == null && projectDetails.IsRemoved && projectDetails.Status == (int)ProjectStatusHelper.ProjectStatusEnum.NotStarted)
                {
