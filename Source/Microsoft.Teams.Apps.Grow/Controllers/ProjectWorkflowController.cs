...
namespace Microsoft.Teams.Apps.Grow.Controllers
{
    ...
    public class ProjectWorkflowController : BaseGrowController
    {
        ...
        [HttpPatch("join-project/{projectId}")]
        public async Task<IActionResult> JoinProjectAsync([FromBody] ProjectEntity projectEntity)
        {
            ...
            try
            {
                ...
                {
                    this.logger.LogError("Join project details is null or empty.");
                    return this.BadRequest("Join project details is null or empty.");
                }
...
#pragma warning restore CA1031 // Catching general exception occurred while sending notification to user to log error and continue to execute code
                ...
                this.RecordEvent($"Cannot find project {projectEntity?.ProjectId} to join.");
        ...
        /// <returns>Returns true for successful operation.</returns>
        [HttpPatch("close-project/{projectId}")]
        public async Task<IActionResult> CloseProjectAsync(CloseProjectModel closeProjectModel)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(projectDetails.ProjectParticipantsUserIds))
                {
                    ...
                    var verifyMembers = closeProjectModel.ProjectParticipantDetails
                        .Select(participants => participants.UserId)
                        .Intersect(projectMembers).Count() == projectMembers.Length;
