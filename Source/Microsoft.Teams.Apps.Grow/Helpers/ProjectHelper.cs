        ...
        private string CreateProjectStatusQuery(string status)
        {
            try
            {
                ...
                if (projectStatusData.Count() > 1)
                {
                    ...
                    projectStatusQuery.Append($"{nameof(ProjectEntity.Status)} eq {projectStatusData.Last()}");
                }
                else
                {
                    projectStatusQuery.Append($"{nameof(ProjectEntity.Status)} eq {projectStatusData.Last()}");
                ...
                return projectStatusQuery.ToString();
            }
            catch (Exception ex)
            {
        ...
        private string CreateProjectOwnerNamesQuery(string projectOwnerNames)
        {
            try
            {
                ...
                if (ownerNamesData.Count() > 1)
                {
                    ...
                    projectOwnerNamesQuery.Append($"{nameof(ProjectEntity.CreatedByName)} eq '{ownerNamesData.Last()}'");
                }
                else
                {
                    projectOwnerNamesQuery.Append($"{nameof(ProjectEntity.CreatedByName)} eq '{ownerNamesData.Last()}'");
                ...
                return projectOwnerNamesQuery.ToString();
            }
            catch (Exception ex)
            {
